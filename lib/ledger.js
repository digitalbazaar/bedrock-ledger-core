...
// the pipeline worker is responsible for bootstrapping the ledger
...
// setup event handler to bootstrap the ledger at the appropriate time
function bootstrapLedger() {
  bedrock.events.on('bedrock-ledger-core.init', async () => {
    let ledgerAgent;
    while(!ledgerAgent) {
